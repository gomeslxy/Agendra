...
CREATE INDEX automation_events_company_created ON automation_events (company_id, created_at DESC);
...
-- TTL: deletar eventos com mais de 90 dias para evitar crescimento indefinido
