        ...
        <Glass className="p-9">
          ...
          {message === "password_reset_success" && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-4 rounded-xl border border-[#BBF7D0] bg-[#F0FDF4] px-4 py-3 text-sm text-[#166534] text-center"
            >
          ...
          >
            Ainda não tem conta?{" "}
            <Link href="/signup" className="text-brand-blue-600 hover:underline">
              Crie grátis
            </Link>
          </div>
        </Glass>
